...
import {
  CreditCard, Smartphone, AlertTriangle, ArrowRight,
  Loader2, CheckCircle, History, Clock, XCircle
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl space-y-6">
        ...
        <h1 className="font-display text-2xl md:text-3xl font-bold text-primary neon-text text-center">NẠP THẺ CÀO</h1>
        <p className="text-center text-muted-foreground text-sm">Nạp thẻ cào tự động 24/7 — Chiết khấu 20%</p>
        ...
        {/* Recent Top-up History - Giữ nguyên như bản gốc */}
        {user && (
